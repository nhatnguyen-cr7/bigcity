...
var FullCalendar = (function (e) {
            ...
            return (
                (e.prototype.splitProps = function (e) {
                    var t = this,
                        ...
                        u = {};
                    for (var c in ((this.eventUiBuilders = gt(
                        n,
                        function (e, n) {
    ...
    var ko = (function (e) {
        ...
        return (
            ...
            (t.prototype.shouldComponentUpdate = function (e, t) {
                return (
                    this.debug &&
                        console.log(St(e, this.props), St(t, this.state)),
    ...
    var Fo = (function (e) {
            ...
            return (
                ...
                (t.prototype.renderInnerContent = function () {
                    ...
                    if (
                        (void 0 === o &&
                            (o = Go(t.defaultContent, t.hookProps)),
                        void 0 !== o)
                    ) {
            ...
            function (e) {
                return (function (e, t, n, o, i) {
                    ...
                    return {
                        ...
                        buttonTextDefault:
                            p(i) || e.defaults.buttonText || p(on) || e.type,
                    };
                })(e, a, t, n, o);
            }
        );
        ...
        Ho({
            ...
            propSetHandlers: {
                dateProfile: function (e, t) {
                    t.emitter.trigger(
                        "datesSet",
                        r(r({}, lr(e.activeRange, t.dateEnv)), {
                            view: t.viewApi,
                        })
                    );
                },
    ...
    var Ri = (function () {
        function e(e) {
            ...
            (this.computeOptionsData = Ft(this._computeOptionsData)),
                (this.computeCurrentViewData = Ft(
            ...
            return (
                ...
                (e.prototype.findInsertion = function (e) {
                    for (
                        ...
                        for (
                            c = u = m[0] + m[1];
                            (g = v[c]) && g.span.start < e.span.end;

                        )
                            (i ||
                                (s < h + g.thickness && s + e.thickness > h)) &&
        ...
        return (
            ...
            (t.prototype.render = function () {
                ...
                return mo(
                    ...
                    Boolean(!v && p.length) &&
                        mo.apply(void 0, o(["thead", {}], p)),
                    Boolean(!v && f.length) &&
                        mo.apply(void 0, o(["tbody", {}], f)),
                    Boolean(!v && h.length) &&
                        mo.apply(void 0, o(["tfoot", {}], h)),
    ...
    var es = (function (e) {
        function t() {
            var t = (null !== e && e.apply(this, arguments)) || this;
            return (
                (t.refineHookProps = zt(Qa)), (t.normalizeClassNames = Bo()), t
            );
        }
        return (
            n(t, e),
    ...
    function rs(e) {
        return (
            e.event.title &&
            mo("div", { className: "fc-event-title" }, e.event.title)
        );
    }
    var os = function (e) {
        return mo(_o.Consumer, null, function (t) {
    ...
    function cs(e) {
        if (e.allDayDate)
            return { start: e.allDayDate, end: Ke(e.allDayDate, 1) };
        var t,
            n = e.hiddenSegs;
        return {
            start: ds(n),
        ...
        ys = (function () {
            function e(e) {
                ...
                (this.subjectEl = null),
                    ...
                    1 === (gs += 1) &&
                        window.addEventListener("touchmove", Es, {
                            passive: !1,
                        });
            }
            return (
                (e.prototype.destroy = function () {
                    this.containerEl.removeEventListener(
                        ...
                        (gs -= 1) ||
                            window.removeEventListener("touchmove", Es, {
                                passive: !1,
                            });
                }),
    ...
    function xs(e, t) {
        return (
            (!e && !t) ||
            (Boolean(e) === Boolean(t) && sr(e.dateSpan, t.dateSpan))
        );
    }
    function Ms(e, t) {
        for (
            ...
            return (
                ...
                (e.prototype.computeTimeTop = function (e) {
                    var t,
                        ...
                        i = r.els.length,
                        a =
                            (e.milliseconds - Nt(o.slotMinTime)) /
                            Nt(this.slotDuration);
                    return (
                        (a = Math.max(0, a)),
                        (a = Math.min(i, a)),
                        (t = Math.floor(a)),
    ...
    var Kl = (function (e) {
        function t() {
            var t = (null !== e && e.apply(this, arguments)) || this;
            return (
                (t.buildTimeColsModel = Ft($l)), (t.buildSlatMetas = Ft(Xl)), t
            );
        }
        return (
            n(t, e),
                ...
                return mo(ha, { unit: "day" }, function (e, n) {
                    for (var s = [], l = 0; l < a.length; l += 1) {
                        ...
                        if (u) {
                            ...
                            s.push(
                                mo(Ql, { key: c, dayDate: t[l], todayRange: n })
                            );
                            for (
